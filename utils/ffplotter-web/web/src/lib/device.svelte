...
<div transition:fly={{ y: 100 }}>
    ...
    {:else}
        <div class="p-3 mb-2 bg-gray-300 rounded-lg">
            ...
            <div class="border-1 border-red-600 px-2 py-2 mt-2 rounded text-red-600" transition:slide>
                <button
                    class="cursor-pointer text-sm transition-all hover:bg-red-200 w-fit rounded p-1"
                    onclick={async () => {
                    ...
                    <div transition:slide>
                        ...
                        {:else}
                            <div class="grid grid-cols-[10px_1fr_1fr] gap-2">
                                ...
                                ></i>
                                <p class="text-sm text-gray-800 self-center">Radio Frequency</p>
                                <input
                                    name="frequency"
                                    type="number"
                                ...
                                ></i>
                                <p class="text-sm text-gray-800 self-center">Board ID</p>
                                <input
                                    name="id"
                                    type="number"
                                    class="w-full text-sm bg-gray-100 p-2 mr-2 rounded-xl"
                                ...
                                ></i>
                                <p class="text-sm text-gray-800 self-center">Bandwidth</p>
                                <input
                                    name="bw"
                                    type="number"
                                    class="w-full text-sm bg-gray-100 p-2 mr-2 rounded-xl"
                                ...
                                ></i>
                                <p class="text-sm text-gray-800 self-center">Coding rate</p>
                                <input
                                    name="cr"
                                    type="number"
                                    class="w-full text-sm bg-gray-100 p-2 mr-2 rounded-xl"
                                ...
                                ></i>
                                <p class="text-sm text-gray-800 self-center">Spreading Factor</p>
                                <input
                                    name="sf"
                                    type="number"
                                    class="w-full text-sm bg-gray-100 p-2 mr-2 rounded-xl"
